...
function setupWebServer(app) {
    ...
    app.post('/check-balance', async (req, res) => {
        ...
        try {
            const response = await axios.get(`https://toncenter.com/api/v2/getAddressInformation?address=${walletAddress}&apiKey=21056ad9ac7a551eb551f75fe26186333038a810335ce8735873082ff1167864`);
